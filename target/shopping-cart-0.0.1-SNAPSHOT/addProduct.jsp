	...
	<div class="row" style="margin-top: 5px; margin-left: 2px; margin-right: 2px;">
		<form action="./AddProductSrv" method="post" enctype="multipart/form-data" class="col-md-6 col-md-offset-3"
			...
			<div style="font-weight: bold;" class="text-center">
				<h2 style="color: green;">T-Shirt Addition Form</h2>
				<%
					if (message != null) {
				%>
			...
			<div class="row">
				<div class="col-md-6 form-group">
					<label for="last_name">T-Shirt Name</label>
					<input type="text" placeholder="Enter T-Shirt Name" name="name" class="form-control"  required>
				</div>
				<div class="col-md-6 form-group">
			...
			<div class="form-group">
				<label for="last_name">T-Shirt Description</label>
				<textarea name="info" class="form-control"  required></textarea>
			</div>
			<div class="row">
				<div class="col-md-6 form-group">
					<label for="last_name">Unit Price</label>
					<input type="number" placeholder="Enter Unit Price" name="price" class="form-control"  required>
				</div>
				<div class="col-md-6 form-group">
					<label for="last_name">Stock Quantity</label>
					<input type="number" placeholder="Enter Stock Quantity" name="quantity" class="form-control"  required>
				</div>
			</div>
			<div>
				<div class="col-md-12 form-group">
					<label for="last_name">T-Shirt Image</label>
			...
			<div class="row">
				...
				<div class="col-md-6 text-center">
					<button type="submit" class="btn btn-success">Add T-Shirt</button>
				</div>
			</div>
		</form>
	</div>
